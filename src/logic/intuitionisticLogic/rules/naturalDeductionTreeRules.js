...
const rules = [
  ...
  {
    rule: "nd-tree-ae",
    label: i18n.global.t("rules.absurdum.elimination.label"),
    desc: `${i18n.global.t("rules.absurdum.elimination.title")} (⊥E)`,
    proof:
      ' <div class="q-ma-sm rule"> <div>⊥</div> <div class="rule__border-top"> <span>ϕ</span> <span class="rule__border-top__rule-name">(⊥E)</span> </div> </div>',
  },
  {
    rule: "nd-tree-ne",
  ...
  },
  {
    ...
    proof:
      ' <div class="q-ma-sm rule"> <div><span toReplace>ϕ</span> ∧ <span toInput>ψ</span></div> <div class="rule__border-top"> <span><span toReplace>ϕ</span></span> <span class="rule__border-top__rule-name">(∧E1)</span> </div> </div>',
  },
  {
    rule: "nd-tree-ce2",
    ...
    proof:
      ' <div class="q-ma-sm rule"> <div><span toInput>ψ</span> ∧ <span toReplace>ϕ</span></div> <div class="rule__border-top"> <span><span toReplace>ϕ</span></span> <span class="rule__border-top__rule-name">(∧E2)</span> </div> </div>',
  },
  {
    rule: "nd-tree-di1",
  ...
  },
  {
    ...
    proof:
      ' <div class="q-ma-sm rule"> <div class="rule__siblings"> <div><span toInput>ϕ ∨ ψ</span></div> <div class="rule__hypo"> <div>[<span toDelete>ϕ</span>]</div> <div class="rule__hypo__dots"> <span>.</span> <span>.</span> <span>.</span> </div> <span toReplace>θ</span> </div> <div class="rule__hypo"> <div>[<span toDelete>ψ</span>]</div> <div class="rule__hypo__dots"> <span>.</span> <span>.</span> <span>.</span> </div> <span toReplace>θ</span> </div> </div> <div class="rule__border-top"> <span><span toReplace>θ</span></span> <span class="rule__border-top__rule-name">(∨E)</span> </div> </div>',
  },
  {
    rule: "nd-tree-ii",
  ...
  },
  {
    ...
    proof:
      ' <div class="q-ma-sm rule"> <div class="rule__siblings"> <div><span toInput>ϕ</span></div> <div><span toInput>ϕ</span> ⇒ <span toReplace>ψ</span></div> </div> <div class="rule__border-top"> <span><span toReplace>ψ</span></span> <span class="rule__border-top__rule-name">(⇒E)</span> </div> </div>',
  },
];

...
const rules = [
  ...
  },
  {
    ...
    desc: `${i18n.global.t("rules.universalQuantifier.intro.title")} (∀I, m)`,
    proof:
      '<div class="q-ma-sm fitch-proof"> <!-- formulas --> <div> <div> <span class="fitch-index">m</span> <div class="fitch-formula">φ[t/x]</div> </div> <div> <span class="fitch-index"></span> <div class="fitch-formula">(∀x)φ</div> </div> </div> <!-- rule --> <div> <div class="fitch-rule">&nbsp;</div> <div class="fitch-rule">∀I, m</div> </div> </div>',
    forInput: {
      mask: /^(\d+)$/,
      placeholder: "#",
    },
  },
  {
    ...
    proof:
      '<div class="q-ma-sm fitch-proof"> <!-- formulas --> <div> <div> <span class="fitch-index">m</span> <div class="fitch-formula">(∀x)φ</div> </div> <div> <span class="fitch-index"></span> <div class="fitch-formula">φ[t/x]</div> </div> </div> <!-- rule --> <div> <div class="fitch-rule">&nbsp;</div> <div class="fitch-rule">∀E, m</div> </div> </div>',
    forInput: {
      mask: /^(\d+)$/,
      placeholder: "#",
    },
  },
  {
    ...
    desc: `${i18n.global.t(
      "rules.existentionalQuantifier.intro.title"
    )} (∃I, m)`,
    proof:
      ' <div class="q-ma-sm fitch-proof"> <!-- formulas --> <div> <div> <span class="fitch-index">m</span> <div class="fitch-formula">φ[t/x]</div> </div> <div> <span class="fitch-index"></span> <div class="fitch-formula">(∃x)φ</div> </div> </div> <!-- rule --> <div> <div class="fitch-rule">&nbsp;</div> <div class="fitch-rule">∃I, m</div> </div> </div>',
    forInput: {
  ...
  },
  {
    ...
    proof:
      '<div class="q-ma-sm fitch-proof"> <!-- formulas --> <div> <div> <span class="fitch-index">m</span> <div class="fitch-formula">(∃x)φ</div> </div> <div> <span class="fitch-index">i</span> <div class="fitch-spacer"> <div class="fitch-formula fitch-as">φ[t/x]</div> </div> </div> <div> <span class="fitch-index">j</span> <div class="fitch-spacer"> <div class="fitch-formula">ψ</div> </div> </div> <div> <span class="fitch-index"></span> <div class="fitch-formula">ψ</div> </div> </div> <!-- rule --> <div> <div class="fitch-rule">&nbsp;</div> <div class="fitch-rule">&nbsp;</div> <div class="fitch-rule">&nbsp;</div> <div class="fitch-rule">∃E, m, i-j</div> </div> </div>',
    forInput: {
      mask: /^(\d+,(\d+-\d+))$/,
      placeholder: "#,#-#",
    },
  ...
  },
  {
    ...
    proof:
      '<div class="q-ma-sm fitch-proof"> <!-- formulas --> <div> <div> <span class="fitch-index">m</span> <div class="fitch-spacer"> <div class="fitch-formula fitch-as">¬φ</div> </div> </div> <div> <span class="fitch-index">n</span> <div class="fitch-spacer"> <div class="fitch-formula">⊥</div> </div> </div> <div> <span class="fitch-index"></span> <div class="fitch-formula">φ</div> </div> </div> <!-- rule --> <div> <div class="fitch-rule--as">&nbsp;</div> <div class="fitch-rule">&nbsp;</div> <div class="fitch-rule">⊥E2, m-n</div> </div> </div>',
    forInput: {
      mask: /^(\d+-\d+)$/,
      placeholder: "#-#",
    },

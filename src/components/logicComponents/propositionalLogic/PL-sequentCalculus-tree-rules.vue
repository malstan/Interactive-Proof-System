      ...
      <q-list bordered separator style="border-radius: 4px">
        ...
        >
          <q-item-section top>
            ...
            <div class="flex" v-html="rule.tree"></div>
          </q-item-section>
        </q-item>
      </q-list>
    </q-scroll-area>
...
import grammar from "src/logic/propositionalLogic/propositionalGrammar";
import { applyGskTreeRule } from "src/logic/propositionalLogic/propositionalFormulaProcessor";

import FormulaInput from "src/components/logicComponents/FormulaInput.vue";
import rules from "src/logic/propositionalLogic/rules/sequentCalculusTreeRules";

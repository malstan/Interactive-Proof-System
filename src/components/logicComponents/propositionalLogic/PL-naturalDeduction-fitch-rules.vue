...
import { applyNdFitchRule } from "src/logic/propositionalLogic/propositionalFormulaProcessor";

import rules from "src/logic/propositionalLogic/rules/naturalDeductionFitchRules";

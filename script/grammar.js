...
var grammar = {
    ...
    {"name": "statement$ebnf$1$subexpression$2", "symbols": [{"literal":","}, "implication"]},
    ...
    {"name": "statement", "symbols": ["implication", "statement$ebnf$1"], "postprocess": 
    ...
    {"name": "implication", "symbols": ["disjunction", {"literal":"⇒"}, "implication"]},
    {"name": "implication", "symbols": ["disjunction"], "postprocess": id},
    {"name": "disjunction", "symbols": ["conjunction", {"literal":"∨"}, "disjunction"]},
    {"name": "disjunction", "symbols": ["conjunction"], "postprocess": id},
    {"name": "conjunction", "symbols": ["negation", {"literal":"∧"}, "conjunction"]},
    ...
    {"name": "term", "symbols": [{"literal":"("}, "statement", {"literal":")"}]},
    {"name": "symbol", "symbols": [/[A-Z]/], "postprocess": id}
]
  , ParserStart: "formula"
}
